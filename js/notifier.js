...
(function () {
    ...
    function showWbCookieNotifier() {
        ...
        el.id = "cookies_notifier";
        el.className = "__wads_no_click";
        ...
        el.style.fontSize = "10px"; /*el.style.lineHeight = "35px";*/
        ...
        a.style.backgroundColor = "#656565";
        a.style.color = "#FFF";
        a.style.textDecoration = "none";
        a.href = "javascript:closeWbCookieNotifier();"
        a.innerHTML = "X";
